...
import 'package:triya_app/ui/candidate_deshboard/home/resume/professional_certificate_controller.dart';
import 'package:triya_app/widgets/bottom_common_button.dart';
import 'package:triya_app/widgets/resume_common_textfiled.dart';

class ProfessionalCertificationScreen extends StatelessWidget {
  ProfessionalCertificationScreen({Key? key}) : super(key: key);
  final controller = Get.put(ProfessionalCertificateController());
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: Column(
        children: [
          CommanTopBar(title: "Professional Certifications"),
          ...
          Padding(
            ...
            child: Column(
              ...
              children: [
                ...
                CommanAddButton(onTap: () {}, title: 'Add certificate')
              ],
            ),
          ),
          Spacer(),
          Padding(
            ...
            child: BottomCommonButton(
                onTap: () {
                  controller.professionalCertificates();
                },
                name: "SAVE"),
          ),
